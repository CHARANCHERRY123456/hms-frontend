...
import { User, Mail, Phone, Calendar, MapPin, CreditCard as Edit, Save, Camera, Shield, Award, Clock, TestTube } from 'lucide-react';

const LabTechnicianProfile: React.FC = () => {
  const [isEditing, setIsEditing] = useState(false);
  const [profileData, setProfileData] = useState({
    name: 'Dr. Rajesh Patel',
    email: 'rajesh.patel@medicarehosp.com',
    phone: '+91 9876543210',
    employeeId: 'LAB001',
    department: 'Laboratory',
    position: 'Senior Lab Technician',
    qualification: 'B.Sc. Medical Laboratory Technology, M.Sc. Clinical Biochemistry',
    experience: '8 years',
    joinDate: '2020-02-15',
  ...
  const stats = [
    { label: 'Tests Completed', value: '2,847', icon: TestTube, color: 'blue' },
    { label: 'Years of Experience', value: '8', icon: Award, color: 'green' },
    { label: 'Average Processing Time', value: '2.5 hrs', icon: Clock, color: 'purple' },
    { label: 'Accuracy Rate', value: '99.2%', icon: Shield, color: 'emerald' }
  ];
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 text-center">
              <div className="relative inline-block">
                ...
                <button className="absolute bottom-0 right-0 p-2 bg-teal-600 rounded-full text-white hover:bg-teal-700 transition-colors duration-200">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-teal-600">{profileData.experience}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center space-x-2 px-4 py-2 bg-teal-600 hover:bg-teal-700 disabled:bg-teal-400 text-white rounded-lg transition-colors duration-200"
              >
                {loading ? (
                  <>
